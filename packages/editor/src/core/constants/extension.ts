...
export enum CORE_EXTENSIONS {
  ...
  CUSTOM_ATTACHMENT = "attachmentComponent",
  CUSTOM_BOOKMARK = "bookmarkComponent",
  CUSTOM_TOGGLE = "toggleComponent",
  CUSTOM_TABLE_OF_CONTENTS = "tableOfContentsComponent",
  CUSTOM_MATH = "mathComponent",
  CUSTOM_COLUMNS = "columnsComponent",
  CUSTOM_COLUMN = "customColumn",
  CUSTOM_BREADCRUMB = "breadcrumbComponent",
  CUSTOM_PAGE_LINK = "pageLinkComponent",
  CUSTOM_LINK = "link",
  DOCUMENT = "doc",
