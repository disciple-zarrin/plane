        ...
        items: [
          {
            ...
            key: "text",
            title: "Text / متن ساده",
            description: "Just start typing with plain text / نوشتن متن معمولی",
            searchTerms: ["p", "paragraph", "text", "matn", "plain", "متن", "پاراگراف", "ساده"],
          ...
          },
          {
            commandKey: "h1",
            key: "h1",
            title: "Heading 1 / تیتر ۱",
            description: "Big section heading / تیتر اصلی و بزرگ",
            searchTerms: ["title", "big", "large", "h1", "heading 1", "titr", "sarfasl", "تیتر", "تیتر ۱", "سرتیتر"],
          ...
          },
          {
            commandKey: "h2",
            key: "h2",
            title: "Heading 2 / تیتر ۲",
            description: "Medium section heading / تیتر متوسط",
            searchTerms: ["subtitle", "medium", "h2", "heading 2", "titr 2", "تیتر ۲", "زیرتیتر"],
          ...
          },
          {
            commandKey: "h3",
            key: "h3",
            title: "Heading 3 / تیتر ۳",
            description: "Small section heading / تیتر کوچک",
            searchTerms: ["subtitle", "small", "h3", "heading 3", "titr 3", "تیتر ۳"],
          ...
          },
          {
            commandKey: "h4",
            key: "h4",
            title: "Heading 4 / تیتر ۴",
            description: "Sub-heading 4 / تیتر سطح ۴",
            searchTerms: ["subtitle", "small", "h4", "heading 4", "titr 4", "تیتر ۴"],
          ...
          },
          {
            commandKey: "h5",
            key: "h5",
            title: "Heading 5 / تیتر ۵",
            description: "Sub-heading 5 / تیتر سطح ۵",
            searchTerms: ["subtitle", "small", "h5", "heading 5", "titr 5", "تیتر ۵"],
          ...
          },
          {
            commandKey: "h6",
            key: "h6",
            title: "Heading 6 / تیتر ۶",
            description: "Sub-heading 6 / تیتر سطح ۶",
            searchTerms: ["subtitle", "small", "h6", "heading 6", "titr 6", "تیتر ۶"],
          ...
          },
          {
            ...
            key: "numbered-list",
            title: "Numbered list / لیست شماره‌دار",
            description: "Create a numbered list / لیست ترتیبی و عددی",
            searchTerms: ["ordered", "number", "list", "shomare", "tartibi", "1.", "لیست", "شماره", "عددی"],
          ...
          },
          {
            ...
            key: "bulleted-list",
            title: "Bulleted list / لیست نشانه‌دار",
            description: "Create a bulleted list / لیست نقطه‌ای",
            searchTerms: ["unordered", "point", "bullet", "noghte", "لیست نقطه‌ای", "گلوله‌ای", "نشانه‌دار"],
          ...
          },
          {
            ...
            key: "to-do-list",
            title: "To-do list / چک‌لیست",
            description: "Create a to-do list / وظایف و چک‌لیست تعاملی",
            searchTerms: ["todo", "task", "list", "check", "checkbox", "cheklist", "kar", "چک لیست", "تسک", "کارها"],
          ...
          },
          {
            ...
            key: "table",
            title: "Table / جدول",
            description: "Create a table / درج جدول داده",
            searchTerms: ["table", "cell", "db", "data", "tabular", "jadval", "sotoon", "جدول", "ستون", "سطر"],
          ...
          },
          {
            ...
            key: "quote",
            title: "Quote / نقل‌قول",
            description: "Capture a quote / کادر نقل‌قول",
            searchTerms: ["blockquote", "quote", "naghl ghol", "ghol", "نقل قول", "گفتاورد"],
          ...
          },
          {
            ...
            key: "code",
            title: "Code / بلوک کد",
            description: "Capture a code snippet / بلوک کدنویسی",
            searchTerms: ["codeblock", "code", "kod", "barnamenevisi", "snippet", "کد", "برنامه‌نویسی"],
          ...
          },
          {
            commandKey: "callout",
            key: "callout",
            title: "Callout / کادر پیام",
            icon: <MessageSquareText className="size-3.5" />,
            description: "Insert callout / درج کادر برجسته پیام",
            searchTerms: ["callout", "comment", "message", "info", "alert", "kadr", "payam", "کادر", "پیام", "هشدار"],
            command: ({ editor, range }: CommandProps) => insertCallout(editor, range),
          },
          {
            commandKey: "divider",
            key: "divider",
            title: "Divider / خط جداکننده",
            description: "Visually divide blocks / خط تفکیک افقی",
            searchTerms: ["line", "divider", "horizontal", "rule", "separate", "khat", "jodakonande", "خط", "جداکننده"],
          ...
          },
          {
            ...
            key: "emoji",
            title: "Emoji / ایموجی",
            description: "Insert an emoji / درج شکلک و ایموجی",
            searchTerms: ["emoji", "icons", "reaction", "emoticon", "emotags", "sheklak", "ایموجی", "شکلک"],
