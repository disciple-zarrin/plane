  ...
  return (
    <div className="flex w-full flex-col divide-y-2 divide-subtle-1">
      <div className="w-full overflow-y-auto">
        <h5 className="mb-2 text-body-sm-medium">{t("inbox.issue.properties") || "مشخصات"}</h5>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex h-8 items-center gap-2">
              ...
              <MemberDropdown
                ...
                disabled={!isEditable}
                projectId={projectId?.toString() ?? ""}
                placeholder={t("common.add_assignees") || "افزودن مسئول"}
                multiple
                buttonVariant={
        ...
        <div className={`mt-3 divide-y-2 divide-subtle-1 ${!isEditable ? "opacity-60" : ""}`}>
          <div className="flex flex-col gap-3">
            ...
            <div className="flex h-8 items-center gap-2">
              ...
              <DateDropdown
                placeholder={t("common.add_due_date") || "افزودن تاریخ مهلت"}
